#!/usr/bin/env node
/**
 * Get React/TypeScript source code implementation for BlakeUI components.
 *
 * Usage:
...
const GITHUB_RAW_BASE = "https://raw.githubusercontent.com/myblakebox/BlakeUI/refs/heads/main";
    ...
    try {
      ...
      if (response.ok) {
        ...
        return {
          component,
          filePath: path,
          githubUrl: `https://github.com/myblakebox/BlakeUI/blob/main/${path}`,
          source: "fallback",
          sourceCode: content,
        };
      }
