#!/usr/bin/env node
/**
 * Get complete component documentation (MDX) for BlakeUI Native components.
 *
 * Usage:
...
const FALLBACK_BASE = "https://blakeui.com";
  ...
  try {
    const options = {
      headers: {
        ...
        "User-Agent": "BlakeUI-Native-Skill/1.0",
      },
      method,
...
/**
 * Fetch MDX directly from v3.blakeui.com as fallback.
 */
