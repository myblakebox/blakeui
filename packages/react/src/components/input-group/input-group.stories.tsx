...
export const WithTextPrefix: Story = {
  render: () => (
    <TextField className="w-[280px]" defaultValue="blakeui.com" name="website">
      <Label>Website</Label>
      <InputGroup>
...
export const WithTextSuffix: Story = {
  render: () => (
    <TextField className="w-[280px]" defaultValue="blakeui" name="website">
      <Label>Website</Label>
      <InputGroup>
        <InputGroup.Input className="w-[280px]" />
  ...
  render: () => (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        ...
        <TextField className="w-[280px]" defaultValue="blakeui.com" name="website1">
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Prefix>https://</InputGroup.Prefix>
            <InputGroup.Input className="w-[280px]" />
        ...
        <TextField className="w-[280px]" defaultValue="blakeui" name="website2">
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Input className="w-[280px]" />
            <InputGroup.Suffix>.com</InputGroup.Suffix>
        ...
        <TextField className="w-[280px]" defaultValue="blakeui" name="website3">
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Prefix>
              <Icon className="size-4 text-muted" icon="gravity-ui:globe" />
        ...
        <TextField className="w-[280px]" defaultValue="blakeui.com" name="website4">
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Input className="w-[280px]" />
            <InputGroup.Suffix className="pr-0">
        ...
        <TextField className="w-[280px]" defaultValue="blakeui.com" name="website5">
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Prefix>
              <Icon className="size-4 text-muted" icon="gravity-ui:globe" />
