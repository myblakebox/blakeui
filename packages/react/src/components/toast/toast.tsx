...
import type {ToastVariants} from "@blakeui/styles";
...
import {toastVariants} from "@blakeui/styles";
import React, {
  createContext,
  useCallback,
  useContext,
...
Toast.displayName = "BlakeUI.Toast";
...
ToastIndicator.displayName = "BlakeUI.ToastIndicator";
...
ToastTitle.displayName = "BlakeUI.ToastTitle";
...
ToastDescription.displayName = "BlakeUI.ToastDescription";
...
ToastCloseButton.displayName = "BlakeUI.ToastCloseButton";
...
ToastActionButton.displayName = "BlakeUI.ToastActionButton";
...
const ToastProvider = <T extends object = ToastContentValue>({
  ...
  const toastQueue = useMemo((): StatelyToastQueue<T> => {
    if (queueProp) {
      // Region consumes the underlying react-stately queue, not the BlakeUI wrapper.
...
ToastProvider.displayName = "BlakeUI.ToastProvider";
