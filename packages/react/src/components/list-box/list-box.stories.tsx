  ...
  render: () => (
    <ListBox aria-label="Users" className="w-[220px]" selectionMode="single">
      <ListBox.Item id="1" textValue="Bob">
        <Avatar size="sm">
          <AvatarImage src="https://cdn.blakeui.com/avatars/blue.jpg" />
      ...
      <ListBox.Item id="2" textValue="Fred">
        <Avatar size="sm">
          <AvatarImage src="https://cdn.blakeui.com/avatars/green.jpg" />
      ...
      <ListBox.Item id="3" textValue="Martha">
        <Avatar size="sm">
          <AvatarImage src="https://cdn.blakeui.com/avatars/purple.jpg" />
