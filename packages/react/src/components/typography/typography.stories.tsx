...
export const InlineCode: Story = {
  render: () => (
    <div className="flex max-w-2xl flex-col gap-4">
      <Typography.Paragraph>
        Install the package with <Typography.Code>pnpm add @blakeui/react</Typography.Code> and
  ...
  render: () => (
    <article className="flex max-w-2xl flex-col gap-4">
      ...
      <Typography.Paragraph>
        ...
        standard — and derive heading sizes using a consistent ratio. BlakeUI uses a tracking-tight
      ...
      <Typography.Paragraph color="muted" size="sm">
        ...
        readability. These defaults work out of the box with BlakeUI's Typography primitive.
      </Typography.Paragraph>
    </article>
  ),
};
...
export const ProseBlock: Story = {
  render: () => (
    <Typography.Prose className="max-w-2xl">
      <h1>Getting Started with BlakeUI</h1>
      <p>
        BlakeUI is a modern React component library built on top of <strong>Tailwind CSS v4</strong>{" "}
      ...
      <p>
        ...
        <code>@blakeui/react</code> package includes every component:
      </p>
      <pre>
        <code>pnpm add @blakeui/react</code>
      </pre>
      ...
      <h2>Next Steps</h2>
      <p>
        Explore the <a href="https://blakeui.com">component stories</a> in Storybook to see every
