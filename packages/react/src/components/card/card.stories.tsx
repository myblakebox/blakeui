  ...
  render: (args) => (
    <Card className="w-full items-stretch md:flex-row" {...args}>
      <img
        ...
        loading="lazy"
        src="https://cdn.blakeui.com/components/card/porsche-911.png"
      />
    ...
    <div className="flex gap-4">
      <Card className="w-[200px] gap-2" {...args}>
        <img
          ...
          loading="lazy"
          src="https://cdn.blakeui.com/docs/demo1.jpg"
        />
        <Card.Header>
        ...
        <Card.Footer className="flex gap-2">
          <Avatar aria-label="Martha's profile picture" className="size-5">
            <Avatar.Image alt="Martha's avatar" src="https://cdn.blakeui.com/avatars/red.jpg" />
      ...
      <Card className="w-[200px] gap-2" {...args}>
        <img
          ...
          className="pointer-events-none aspect-square w-14 rounded-2xl object-cover select-none"
          loading="lazy"
          src="https://cdn.blakeui.com/docs/demo2.jpg"
        />
        <Card.Header>
        ...
        <Card.Footer className="flex gap-2">
          <Avatar aria-label="John's profile picture" className="size-5">
            <Avatar.Image
              ...
              src="https://cdn.blakeui.com/avatars/blue.jpg"
            />
        ...
        <Card className="col-span-12 flex h-auto min-h-[152px] flex-col sm:flex-row" {...args}>
          <div className="relative h-[140px] w-full shrink-0 overflow-hidden rounded-2xl sm:h-[120px] sm:w-[120px]">
            <img
              ...
              loading="lazy"
              src="https://cdn.blakeui.com/docs/cherries.jpeg"
            />
          </div>
          <div className="flex flex-1 flex-col gap-3">
            <Card.Header className="gap-1">
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 grid grid-cols-12 gap-4 lg:col-span-6">
            ...
            <div className="col-span-12 grid grid-cols-12 gap-4">
              ...
              <Card className="col-span-12 gap-2 sm:col-span-6">
                <Card.Header>
                  <Avatar className="size-[56px] rounded-xl">
                    <Avatar.Image alt="Demo 2" src="https://cdn.blakeui.com/docs/demo2.jpg" />
                ...
                <Card.Footer className="flex items-center gap-2">
                  <Avatar className="size-4">
                    <Avatar.Image alt="John" src="https://cdn.blakeui.com/avatars/blue.jpg" />
          ...
          <Card className="col-span-12 min-h-[200px] rounded-3xl lg:col-span-6" {...args}>
            ...
            <img
              ...
              src="https://cdn.blakeui.com/docs/neo2.jpeg"
            />
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4">
          ...
          >
            <img
              ...
              aria-hidden="true"
              className="absolute inset-0 h-full w-full object-cover"
              src="https://cdn.blakeui.com/docs/neo1.jpeg"
            />
          ...
          <div className="col-span-12 flex flex-col gap-2 md:col-span-4 md:justify-between md:gap-0">
            ...
            <Card className="flex flex-row gap-3 p-1" variant="transparent">
              <img
                ...
                loading="lazy"
                src="https://cdn.blakeui.com/docs/robot1.jpeg"
              />
            ...
            <Card className="flex flex-row gap-3 p-1" variant="transparent">
              <img
                ...
                className="aspect-square h-16 w-16 shrink-0 rounded-xl object-cover select-none sm:h-20 sm:w-20"
                loading="lazy"
                src="https://cdn.blakeui.com/docs/avocado.jpeg"
              />
              <div className="flex flex-1 flex-col justify-center gap-1">
            ...
            <Card className="flex flex-row gap-3 p-1" variant="transparent">
              <img
                ...
                className="aspect-square h-16 w-16 shrink-0 rounded-xl object-cover select-none sm:h-20 sm:w-20"
                loading="lazy"
                src="https://cdn.blakeui.com/docs/oranges.jpeg"
              />
              <div className="flex flex-1 flex-col justify-center gap-1">
