...
const users = [
  {
    id: 1,
    image_url: "https://cdn.blakeui.com/avatars/users/3.jpg",
    name: "John",
  },
  {
    id: 2,
    image_url: "https://cdn.blakeui.com/avatars/users/5.jpg",
    name: "Kate",
  },
  {
    id: 3,
    image_url: "https://cdn.blakeui.com/avatars/users/20.jpg",
    name: "Emily",
  },
  {
    id: 4,
    image_url: "https://cdn.blakeui.com/avatars/users/23.jpg",
    name: "Michael",
  },
  {
    id: 5,
    image_url: "https://cdn.blakeui.com/avatars/users/16.jpg",
    name: "Olivia",
  },
];
...
const circles = [
  ...
  {
    id: 4,
    image_url: "https://cdn.blakeui.com/avatars/white.jpg",
    name: "W",
  },
  {
    id: 5,
...
const Template = ({color, size}: Avatar["RootProps"]) => (
  <div className="flex items-start gap-4">
    ...
    <div className="flex flex-col gap-4">
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Junior Garcia" src="https://cdn.blakeui.com/avatars/users/4.jpg" />
        <Avatar.Fallback delayMs={600}>JG</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Junior Garcia" src="https://cdn.blakeui.com/avatars/users/5.jpg" />
        <Avatar.Fallback delayMs={600}>JG</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Paul" src="https://cdn.blakeui.com/avatars/users/8.jpg" />
    ...
    <div className="flex flex-col gap-4">
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Red" src="https://cdn.blakeui.com/avatars/red.jpg" />
        <Avatar.Fallback>R</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Orange" src="https://cdn.blakeui.com/avatars/orange.jpg" />
        <Avatar.Fallback>O</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Green" src="https://cdn.blakeui.com/avatars/green.jpg" />
        <Avatar.Fallback>G</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt="White" src="https://cdn.blakeui.com/avatars/white.jpg" />
        <Avatar.Fallback>W</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Black" src="https://cdn.blakeui.com/avatars/black.jpg" />
...
const TemplateWithDelay = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      <Avatar color={color} size={size}>
        <Avatar.Image
          src={`https://app.requestly.io/delay/${delay}/https://cdn.blakeui.com/avatars/users/3.jpg`}
        />
      </Avatar>
    </div>
  );
...
export const Sizes = {
  render: () => (
    <div className="flex items-center gap-4">
      <Avatar size="sm">
        <Avatar.Image alt="Small" src="https://cdn.blakeui.com/avatars/users/3.jpg" />
        <Avatar.Fallback>SM</Avatar.Fallback>
      </Avatar>
      <Avatar size="md">
        <Avatar.Image alt="Medium" src="https://cdn.blakeui.com/avatars/users/4.jpg" />
        <Avatar.Fallback>MD</Avatar.Fallback>
      </Avatar>
      <Avatar size="lg">
        <Avatar.Image alt="Large" src="https://cdn.blakeui.com/avatars/users/5.jpg" />
...
const VariantsTemplate = (props: AvatarRootProps) => {
  ...
  const variants = [
    ...
    {label: "icon soft", type: "icon-soft", content: <Icon icon="gravity-ui:person" />},
    {
      ...
      type: "img",
      content: [
        "https://cdn.blakeui.com/avatars/blue.jpg",
        "https://cdn.blakeui.com/avatars/black.jpg",
        "https://cdn.blakeui.com/avatars/green.jpg",
        "https://cdn.blakeui.com/avatars/orange.jpg",
        "https://cdn.blakeui.com/avatars/red.jpg",
      ],
    },
  ] as const;
