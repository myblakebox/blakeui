  ...
  render: () => (
    <div className="max-w-md">
      <div className="space-y-1">
        <h4 className="text-medium font-medium">BlakeUI Components</h4>
...
const items = [
  {
    iconUrl: "https://cdn.blakeui.com/docs/3dicons/bell-small.png",
    subtitle: "Receive account activity updates",
    title: "Set Up Notifications",
  },
  {
    iconUrl: "https://cdn.blakeui.com/docs/3dicons/compass-small.png",
    subtitle: "Connect your browser to your account",
    title: "Set up Browser Extension",
  },
  {
    iconUrl: "https://cdn.blakeui.com/docs/3dicons/mint-collective-small.png",
