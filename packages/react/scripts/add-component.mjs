...
${componentName}.displayName = "BlakeUI.${componentName}";
`;
...
`;
  ...
  console.log(`      - import { ${componentName} } from "@blakeui/react"`);
  console.log(`      - import { ${componentName} } from "@blakeui/react/${kebabName}"`);
}
