    ...
    <div>
      ...
      <main className="flex flex-col gap-4 p-6">
        ...
        <p className="rounded-xl text-sm text-muted">
          BlakeUI is the modern UI library for web and mobile.
        </p>
        {/* Buttons */}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Avatar>
                <Avatar.Image alt="User" src="https://cdn.blakeui.com/avatars/users/3.jpg" />
                ...
                <Modal.Container>
                  <Modal.Dialog className="sm:max-w-[360px]">
                    ...
                    <Modal.Header>
                      ...
                      <Modal.Heading>Welcome to BlakeUI</Modal.Heading>
                    </Modal.Header>
                    <Modal.Body>
            ...
            <Popover>
              <Popover.Trigger aria-label="User info" className="flex items-center">
                <div className="flex cursor-pointer items-center gap-2">
                  <Avatar className="size-5" size="sm">
                    <Avatar.Image alt="Zoe" src="https://cdn.blakeui.com/avatars/users/5.jpg" />
              ...
              <Popover.Content className="w-[280px]">
                <Popover.Dialog className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-muted">Design Engineer, @blake_ui lover 🎉</p>
