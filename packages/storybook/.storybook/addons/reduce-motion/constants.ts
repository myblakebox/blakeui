export const REDUCE_MOTION_ADDON_ID = "blakeui-reduce-motion-addon";
export const REDUCE_MOTION_GLOBAL_TYPE_ID = "blakeui-reduce-motion";
export const REDUCE_MOTION_PARAM_KEY = "blakeui-reduce-motion";
