export const THEME_ADDON_ID = "blakeui-theme-addon";
export const THEME_GLOBAL_TYPE_ID = "blakeui-theme";
export const THEME_PARAM_KEY = "blakeui-theme";
export const THEME_EVENT_NAME = "blakeui-theme-changed";
