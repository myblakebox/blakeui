...
// BlakeUI Colors (OKLCH -> Hex approximation)
const colors = {
  white: "#FFFFFF",
  black: "#000000",
  zinc: {
...
const lightTheme = create({
  ...
  base: "light",
  brandTitle: `<img src="/logo-dark.svg" style="width: 120px; height: auto;" alt="BlakeUI"/>`,
  // brandUrl: "https://blakeui.com",
  brandTarget: "_self",
  // Colors
...
const darkTheme = create({
  ...
  base: "dark",
  brandTitle: `<img src="/logo-light.svg" style="width: 120px; height: auto;" alt="BlakeUI"/>`,
  // brandUrl: "https://blakeui.com",
  brandTarget: "_self",
  // Colors
  colorPrimary: colors.accent.DEFAULT,
