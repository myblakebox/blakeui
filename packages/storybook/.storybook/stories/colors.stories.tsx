  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      <div className="mb-8">
        ...
        <p className="text-muted">BlakeUI's color palette with CSS variables and computed values</p>
      </div>
...
AllColors.parameters = {
  docs: {
    description: {
      story:
        "A comprehensive overview of all color tokens available in the BlakeUI design system. Each color shows its CSS variable name and computed value.",
    },
  },
};
