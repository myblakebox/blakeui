# BlakeUI CLI Contributing Guide

Hello!, I am very excited that you are interested in contributing with BlakeUI CLI. However, before submitting your contribution, be sure to take a moment and read the following guidelines.

- [Code of Conduct](https://github.com/myblakebox/BlakeUI/blob/main/CODE_OF_CONDUCT.md)
...
1. Fork of the blakeui cli repository and clone your fork
...
2. Run dev to start development
   ...
   ```bash
   ## Start the dev babel server of BlakeUI CLI
   pnpm dev
   ```
...
4. Test locally
   ...
   npm link
   ## then run @blakeui/cli locally and test
   ```
