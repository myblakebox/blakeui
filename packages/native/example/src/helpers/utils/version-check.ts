...
/** App Store link for the BlakeUI Native app */
export const APP_STORE_URL =
  'https://apps.apple.com/us/app/@blakeui/native/id6757860059';

/** Resolved bundle/package identifier per platform */
const bundleInfo = Platform.select({
  ios: {
    id: Constants.expoConfig?.ios?.bundleIdentifier ?? 'com.blakeuinative.app',
  },
  android: {
    id: Constants.expoConfig?.android?.package ?? 'com.blakeuinative.android',
  },
});
