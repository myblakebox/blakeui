...
import { Avatar, cn } from '@blakeui/native';
    ...
    <View className="flex-1 px-5 items-center justify-center">
      <View className="flex-row items-center justify-center gap-4">
        <Avatar size="sm">
          <Avatar.Image
            source={{
              uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/blue.jpg',
            }}
          />
          <Avatar.Fallback />
        </Avatar>
        <Avatar size="md">
          <Avatar.Image
            source={{
              uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/purple.jpg',
            }}
          />
        ...
        <Avatar size="lg">
          <Avatar.Image
            source={{
              uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/red.jpg',
            }}
          />
...
const avatarGroupData = [
  {
    id: 1,
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/blue.jpg',
    name: 'John Doe',
  },
  {
    id: 2,
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/green.jpg',
    name: 'Kate Wilson',
  },
  {
    id: 3,
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/purple.jpg',
    name: 'Emily Chen',
  },
  {
    id: 4,
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/orange.jpg',
    name: 'Michael Brown',
  },
];
    ...
    <View className="flex-1 px-5 items-center justify-center">
      <View className="flex-row items-center justify-center gap-4">
        <Avatar className="h-16 w-16">
          <Avatar.Image
            source={{
              uri: 'https://img.blakeui.chat/image/avatar?w=400&h=400&u=3',
            }}
          />
        ...
        <Avatar className="rounded-lg">
          <Avatar.Image
            source={{
              uri: 'https://img.blakeui.chat/image/avatar?w=400&h=400&u=5',
            }}
          />
        ...
        <Avatar className="p-[2.5px]" size="lg">
          ...
          <Avatar.Image
            ...
            source={{
              uri: 'https://img.blakeui.chat/image/avatar?w=400&h=400&u=20',
            }}
          />
        ...
        <View className="relative">
          <Avatar size="lg">
            <Avatar.Image
              source={{
                uri: 'https://img.blakeui.chat/image/avatar?w=400&h=400&u=23',
              }}
              asChild
            >
              <Image
