import { Button, Card, cn, type CardRootProps } from '@blakeui/native';
        ...
        <Card className="flex-1 aspect-[1/1.3]">
          <View className="flex-1 gap-4">
            <Card.Header>
              <StyledImage
                source={{
                  uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/docs/demo1.jpg',
                }}
        ...
        <Card className="flex-1 aspect-[1/1.3]">
          <View className="flex-1 gap-4">
            <Card.Header>
              <StyledImage
                source={{
                  uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/docs/demo2.jpg',
                }}
                className="h-16 aspect-square rounded-xl"
              />
            </Card.Header>
    ...
    <View className="flex-1 items-center justify-center px-5">
      <View className="w-full gap-4">
        <Card className="flex-row gap-4 p-4" variant="tertiary">
          <StyledImage
            source={{
              uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/docs/avocado.jpeg',
            }}
        ...
        <Card className="flex-row gap-4 p-4" variant="tertiary">
          <StyledImage
            source={{
              uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/docs/oranges.jpeg',
            }}
            className="h-28 aspect-square rounded-2xl"
            resizeMode="cover"
          />
  ...
  return (
    <View className="flex-1 items-center justify-center px-5">
      <Card className="w-full aspect-square">
        <Image
          source={{
            uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/docs/neo2.jpeg',
          }}
