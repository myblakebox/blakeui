      ...
      <Button
        ...
        onPress={() =>
          toast.show({
            ...
            label: 'Join a team',
            description:
              'Junior Garcia sent you an invitation to join BlakeUI team!',
            icon: (
      ...
      <Button
        ...
        onPress={() =>
          toast.show({
            variant: 'success',
            label: 'Plan upgraded',
            description: 'You can continue using BlakeUI Chat and more',
            icon: (
              <View className="mt-0.5">
                <ShieldCheckIcon
                  size={20}
      ...
      <Button
        ...
        onPress={() =>
          toast.show({
            ...
            description:
              'Upgrade to a paid plan to continue using BlakeUI Chat',
            icon: (
              <View className="mt-0.5">
...
const PlacementVariantsContent = () => {
  ...
  const showBottomToast = () =>
    toast.show({
      ...
      placement: 'bottom',
      label: 'No credits left',
      description: 'Upgrade to a paid plan to continue using BlakeUI Chat',
      icon: (
        <View className="mt-0.5">
          <ShieldExclamationIcon
            size={20}
