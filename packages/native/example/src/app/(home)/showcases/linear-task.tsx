import { Avatar, Card, Separator } from '@blakeui/native';
          ...
          <View className="flex-row items-center">
            <View className="flex-row">
              <Avatar alt="volo" className="size-6 bg-purple-500">
                <Avatar.Image
                  source={{
                    uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/volo-avatar.png',
                  }}
                />
                <Avatar.Fallback>
