...
const data = [
  {
    imageLight:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/super-app-paywall-light.png',
    imageDark:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/super-app-paywall-dark.png',
  ...
  {
    imageLight:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/raycast-showcase-light.png',
    imageDark:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/raycast-showcase-dark.png',
  ...
  {
    imageLight:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/cooking-onboarding-light-1.png',
    imageDark:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/cooking-onboarding-dark-1.png',
  ...
  {
    imageLight:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/linear-task-light.png',
    imageDark:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/linear-task-dark.png',
    title: 'Linear Issue',
    description:
  ...
  {
    imageLight:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcase-paywall.png',
    imageDark:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcase-paywall.png',
    title: 'Hero Paywall',
    description:
  ...
  {
    imageLight:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcases-onboarding-light-1.png',
    imageDark:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcases-onboarding-dark-1.png',
    title: 'Onboarding',
