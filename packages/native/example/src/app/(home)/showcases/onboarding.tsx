import { Button, cn, Separator } from '@blakeui/native';
...
const cards: CardProps[] = [
  {
    title: 'My First Show',
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcase-onboarding-sneakers-1.png',
    liveCount: 23,
    category: 'Sneakers',
    brands: 'AetherStep',
  },
  {
    ...
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcase-onboarding-fashion.png',
    liveCount: 45,
    category: 'Fashion',
    brands: 'Maison Orrix',
  },
  {
    title: 'Tech Gadgets',
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcase-onboarding-headphones.png',
    liveCount: 12,
  ...
  },
  {
    ...
    image:
      'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/images/blakeui-native-example/showcase-onboarding-sneakers-2.png',
    liveCount: 8,
