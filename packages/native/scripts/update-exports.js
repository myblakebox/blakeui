...
function updateExports() {
  try {
    ...
    newExports['./provider'] = {
      source: './src/providers/blake-ui-native/index.ts',
      types: './lib/typescript/src/providers/blake-ui-native/index.d.ts',
      default: './lib/module/providers/blake-ui-native/index.js',
    };

    // Add hardcoded raw provider export
    newExports['./provider-raw'] = {
      source: './src/providers/blake-ui-native-raw/index.ts',
      types: './lib/typescript/src/providers/blake-ui-native-raw/index.d.ts',
      default: './lib/module/providers/blake-ui-native-raw/index.js',
    };
