...
BlakeUI Native follows a **strict design system** based on our Figma designs and roadmap. To ensure consistency and quality:
...
1. **GitHub Discussions** (Preferred): Start a discussion in [GitHub Discussions](https://github.com/myblakebox/BlakeUI/discussions)
...
```sh
Running "BlakeuiNativeExample" with {"fabric":true,"initialProps":{"concurrentRoot":true},"rootTag":1}
```
...
When adding new components to BlakeUI Native, follow our standardized component engineering process to ensure consistency and quality across the library.
...
5. **API Compatibility**: Component structure and API must align with the latest BlakeUI web version where possible
