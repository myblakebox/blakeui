...
Root.displayName = 'BlakeUINative.Primitive.Select.Root';
Trigger.displayName = 'BlakeUINative.Primitive.Select.Trigger';
TriggerIndicator.displayName = 'BlakeUINative.Primitive.Select.TriggerIndicator';
Value.displayName = 'BlakeUINative.Primitive.Select.Value';
Overlay.displayName = 'BlakeUINative.Primitive.Select.Overlay';
PopoverContent.displayName = 'BlakeUINative.Primitive.Select.PopoverContent';
DialogContent.displayName = 'BlakeUINative.Primitive.Select.DialogContent';
Close.displayName = 'BlakeUINative.Primitive.Select.Close';
Item.displayName = 'BlakeUINative.Primitive.Select.Item';
ItemLabel.displayName = 'BlakeUINative.Primitive.Select.ItemLabel';
ItemIndicator.displayName = 'BlakeUINative.Primitive.Select.ItemIndicator';
Group.displayName = 'BlakeUINative.Primitive.Select.Group';
GroupLabel.displayName = 'BlakeUINative.Primitive.Select.GroupLabel';
