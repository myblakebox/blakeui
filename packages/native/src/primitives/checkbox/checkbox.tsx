...
Root.displayName = 'BlakeUINative.Primitive.Checkbox.Root';
...
Trigger.displayName = 'BlakeUINative.Primitive.Checkbox.Trigger';
...
Indicator.displayName = 'BlakeUINative.Primitive.Checkbox.Indicator';
