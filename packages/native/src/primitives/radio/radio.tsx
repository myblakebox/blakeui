...
Root.displayName = 'BlakeUINative.Primitive.Radio.Root';
...
Trigger.displayName = 'BlakeUINative.Primitive.Radio.Trigger';
...
Indicator.displayName = 'BlakeUINative.Primitive.Radio.Indicator';
