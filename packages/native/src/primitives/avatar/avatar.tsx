...
Root.displayName = 'BlakeUINative.Primitive.Avatar.Root';
...
Image.displayName = 'BlakeUINative.Primitive.Avatar.Image';
...
Fallback.displayName = 'BlakeUINative.Primitive.Avatar.Fallback';
