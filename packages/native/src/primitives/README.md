...
These primitives have been adapted for use in BlakeUI Native with modifications for:

- TypeScript compatibility and stricter typing
- Integration with BlakeUI Native's theme system
- Enhanced accessibility features
- Custom styling patterns aligned with BlakeUI design principles

## Usage

These primitives serve as the foundation for BlakeUI Native's component library. They provide:
