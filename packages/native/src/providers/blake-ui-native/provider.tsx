...
import type { BlakeUINativeProviderProps } from './types';

/**
 * BlakeUINativeProvider Component
 *
 * @description
 * Main provider component for BlakeUI Native that configures the application
 * with global settings. This component should wrap your entire application
 * or the section where you want to use BlakeUI Native components.
 *
 * Currently provides:
 ...
 *
 * @param {BlakeUINativeProviderProps} props - Provider configuration props
 * @param {ReactNode} props.children - Child components to wrap
 * @param {BlakeUINativeConfig} [props.config] - Configuration object
 *
 */
const BlakeUINativeProvider: React.FC<BlakeUINativeProviderProps> = ({
  children,
  config = {},
}) => {
...
export default BlakeUINativeProvider;
