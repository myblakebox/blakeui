...
export const DISPLAY_NAME = {
  ROOT: 'BlakeUINative.SubMenu.Root',
  TRIGGER: 'BlakeUINative.SubMenu.Trigger',
  TRIGGER_INDICATOR: 'BlakeUINative.SubMenu.TriggerIndicator',
  CONTENT: 'BlakeUINative.SubMenu.Content',
};
