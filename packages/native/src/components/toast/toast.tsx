...
import { CloseIcon, BlakeText } from '../../helpers/internal/components';
...
const ToastTitle = forwardRef<View, ToastTitleProps>((props, ref) => {
  ...
  return (
    <BlakeText ref={ref} className={labelClassName} {...restProps}>
      {children}
    </BlakeText>
  );
});
 ...
 *
 * @see Full documentation: https://blakeui.com/docs/native/components/toast
 */
