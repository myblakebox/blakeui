...
```tsx
import { Checkbox } from '@blakeui/native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/checkbox.tsx>).
...
```tsx
import { useCheckbox } from '@blakeui/native';
