...
```tsx
import { Popover } from '@blakeui/native';
```
...
import { Button, Popover, useThemeColor } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/popover.tsx>).
...
```tsx
import { usePopover } from '@blakeui/native';
...
```tsx
import { usePopoverAnimation } from '@blakeui/native';
