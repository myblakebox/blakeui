...
```tsx
import { Accordion } from '@blakeui/native';
```
...
```tsx
import { Accordion, PressableFeedback } from '@blakeui/native';
...
```tsx
import { Accordion, useThemeColor } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/accordion.tsx>).
...
```tsx
import { useAccordion } from '@blakeui/native';
...
```tsx
import { useAccordionItem } from '@blakeui/native';
...
```jsx
import { Accordion, AccordionLayoutTransition } from '@blakeui/native';
