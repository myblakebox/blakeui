...
export const DISPLAY_NAME = {
  ROOT: 'BlakeUINative.Accordion.Root',
  ITEM: 'BlakeUINative.Accordion.Item',
  TRIGGER: 'BlakeUINative.Accordion.Trigger',
  INDICATOR: 'BlakeUINative.Accordion.Indicator',
  CONTENT: 'BlakeUINative.Accordion.Content',
  CHEVRON_DOWN_ICON: 'BlakeUINative.Accordion.ChevronDownIcon',
} as const;
