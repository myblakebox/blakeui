...
```tsx
import { Chip } from '@blakeui/native';
```
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/chip.tsx>).
...
```tsx
import { useChip } from '@blakeui/native';
