...
```tsx
import { PressableFeedback } from '@blakeui/native';
```
...
```tsx
import { PressableFeedback, Card, Button } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/pressable-feedback.tsx>).
