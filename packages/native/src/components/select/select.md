...
```tsx
import { Select } from '@blakeui/native';
```
...
```tsx
import { Select, Separator } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/select.tsx>).
...
```tsx
import { useSelect } from '@blakeui/native';
...
```tsx
import { useSelectAnimation } from '@blakeui/native';
...
```tsx
import { useSelectItem } from '@blakeui/native';
