...
import { ChevronRightIcon, BlakeText } from '../../helpers/internal/components';
import type {
  PressableRef,
  TextRef,
  ViewRef,
...
const ListGroupItemTitle = forwardRef<TextRef, ListGroupItemTitleProps>(
  (props, ref) => {
    ...
    return (
      <BlakeText ref={ref} className={titleClassName} {...restProps}>
        {children}
      </BlakeText>
    );
  }
...
>((props, ref) => {
  ...
  return (
    <BlakeText ref={ref} className={descriptionClassName} {...restProps}>
      {children}
    </BlakeText>
  );
});
 ...
 *
 * @see Full documentation: https://blakeui.com/docs/native/components/list-group
 */
