...
```tsx
import { Menu, SubMenu } from '@blakeui/native';
```
...
```tsx
import type { MenuKey } from '@blakeui/native';
import { Button, Menu, Separator } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/menu.tsx>).
...
```tsx
import { useMenu } from '@blakeui/native';
...
```tsx
import { useMenuItem } from '@blakeui/native';
...
```tsx
import { useMenuAnimation } from '@blakeui/native';
...
```tsx
import { useSubMenu } from '@blakeui/native';
