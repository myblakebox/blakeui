  ...
  (props, ref) => {
    ...
    return (
      <AlertPrimitives.Title asChild {...restProps}>
        <BlakeText ref={ref} className={titleClassName}>
          {children}
        </BlakeText>
...
>((props, ref) => {
  ...
  return (
    <AlertPrimitives.Description asChild {...restProps}>
      <BlakeText ref={ref} className={descriptionClassName}>
        {children}
      </BlakeText>
 ...
 *
 * @see Full documentation: https://blakeui.com/docs/native/components/alert
 */
