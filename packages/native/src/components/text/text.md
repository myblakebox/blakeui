...
```tsx
import { Typography } from '@blakeui/native';
```
...
export default function TypographyExample() {
  return (
    <View className="flex-1 justify-center px-5 gap-4">
      ...
      <Typography.Code>npm install @blakeui/native</Typography.Code>
    </View>
  );
}
```

You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/text.tsx>).
