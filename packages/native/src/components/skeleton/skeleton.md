...
```tsx
import { Skeleton } from '@blakeui/native';
```
...
```tsx
import { Avatar, Card, Skeleton } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/skeleton.tsx>).
