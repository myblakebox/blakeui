...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/avatar.tsx>).
...
```tsx
import { Avatar, useAvatar, Skeleton } from '@blakeui/native';
