...
```tsx
import { LinkButton } from '@blakeui/native';
```
...
```tsx
import { Button, Checkbox, ControlField, LinkButton } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/link-button.tsx>).
