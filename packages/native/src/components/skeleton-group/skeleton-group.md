...
```tsx
import { SkeletonGroup } from '@blakeui/native';
```
...
```tsx
import { Card, SkeletonGroup, Avatar } from '@blakeui/native';
      ...
      <Card className="p-4">
        ...
        <SkeletonGroup.Item className="h-48 w-full rounded-lg">
          <View className="h-48 bg-surface-tertiary rounded-lg overflow-hidden">
            <Image
              source={{
                uri: 'https://blakeui-assets.nyc3.cdn.digitaloceanspaces.com/backgrounds/cards/car1.jpg',
              }}
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/skeleton-group.tsx>).
