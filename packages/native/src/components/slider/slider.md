...
```tsx
import { Slider } from '@blakeui/native';
```
...
```tsx
import { Label, Slider } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/slider.tsx>).
...
```tsx
import { useSlider } from '@blakeui/native';
