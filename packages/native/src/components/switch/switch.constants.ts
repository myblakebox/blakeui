...
export const DISPLAY_NAME = {
  SWITCH_ROOT: 'BlakeUINative.Switch.Root',
  SWITCH_THUMB: 'BlakeUINative.Switch.Thumb',
  SWITCH_START_CONTENT: 'BlakeUINative.Switch.StartContent',
  SWITCH_END_CONTENT: 'BlakeUINative.Switch.EndContent',
} as const;
