...
```tsx
import { Description } from '@blakeui/native';
```
...
```tsx
import { Description, TextField } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/description.tsx>).
