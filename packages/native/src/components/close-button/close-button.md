...
```tsx
import { CloseButton } from '@blakeui/native';
```
...
```tsx
import { CloseButton, useThemeColor } from '@blakeui/native';
...
You can find more examples in the [GitHub repository](<https://github.com/myblakebox/BlakeUI/blob/main/example/src/app/(home)/components/close-button.tsx>).
