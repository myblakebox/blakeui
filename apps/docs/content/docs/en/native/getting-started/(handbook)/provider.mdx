---
title: Provider
description: Configure blakeUI Native provider with text, animation, and toast settings
icon: chevrons-expand-horizontal
---

The `BlakeUINativeProvider` is the root provider component that configures and initializes blakeUI Native in your React Native application. It provides global configuration and portal management for your application.
