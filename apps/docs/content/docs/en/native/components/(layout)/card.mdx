...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/card-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/card-docs-dark.mp4"
/>
