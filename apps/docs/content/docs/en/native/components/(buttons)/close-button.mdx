...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/close-button-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/close-button-docs-dark.mp4"
/>
