...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/link-button-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/link-button-docs-dark.mp4"
/>
