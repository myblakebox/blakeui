...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/chip-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/chip-docs-dark.mp4"
/>
