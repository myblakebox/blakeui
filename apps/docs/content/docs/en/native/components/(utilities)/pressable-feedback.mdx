...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/pressable-feedback-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/pressable-feedback-docs-dark.mp4"
/>
  ...
  return (
    <PressableFeedback className="w-full aspect-square overflow-auto">
      <Card className="flex-1">
        <Image
          source={{
            uri: 'https://cdn.blakeui.com/docs/neo2.jpeg',
          }}
