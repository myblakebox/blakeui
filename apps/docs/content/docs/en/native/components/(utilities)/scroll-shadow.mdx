...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/scroll-shadow-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/scoll-shadow-docs-dark.mp4"
/>
