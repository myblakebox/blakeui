...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/text-area-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/text-area-docs-dark.mp4"
/>
...
```tsx
import { Description, FieldError, Label, TextArea, TextField } from '@blakeui/native';
