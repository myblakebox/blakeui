...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/label-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/label-docs-dark.mp4"
/>
