...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/text-field-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/text-field-docs-dark.mp4"
/>
