...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/input-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/input-docs-dark.mp4"
/>
