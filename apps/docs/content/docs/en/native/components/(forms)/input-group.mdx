...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/input-group-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/input-group-docs-dark.mp4"
/>
