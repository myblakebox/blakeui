...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/checkbox-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/checkbox-docs-dark.mp4"
/>
