...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/input-otp-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/input-otp-docs-dark.mp4"
/>
