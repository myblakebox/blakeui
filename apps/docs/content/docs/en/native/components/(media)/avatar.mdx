...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/avatar-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/avatar-docs-dark.mp4"
/>
