...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/popover-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/popover-docs-dark.mp4"
/>
