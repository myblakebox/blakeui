...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/dialog-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/dialog-docs-dark.mp4"
/>
