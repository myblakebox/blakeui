...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/slider-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/slider-docs-dark.mp4"
/>
