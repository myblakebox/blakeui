...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/skeleton-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/skeleton-docs-dark.mp4"
/>
      ...
      <Card className="p-4">
        ...
        <SkeletonGroup.Item className="h-48 w-full rounded-lg">
          <View className="h-48 bg-surface-tertiary rounded-lg overflow-hidden">
            <Image
              source={{
                uri: 'https://cdn.blakeui.com/backgrounds/cards/car1.jpg',
              }}
