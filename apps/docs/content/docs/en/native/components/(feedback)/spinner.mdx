...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/spinner-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/spinner-docs-dark.mp4"
/>
