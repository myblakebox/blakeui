...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/alert-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/alert-docs-dark.mp4"
/>
