...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/tabs-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/tabs-docs-dark.mp4"
/>
