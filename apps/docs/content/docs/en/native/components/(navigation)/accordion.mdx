...
<NativeVideoPlayerView
  target="auto"
  srcLight="https://cdn.blakeui.com/docs/native/components/videos/accordion-docs-light.mp4"
  srcDark="https://cdn.blakeui.com/docs/native/components/videos/accordion-docs-dark-1.mp4"
/>
