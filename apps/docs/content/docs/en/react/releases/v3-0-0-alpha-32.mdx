...
blakeUI now includes an [MCP server](/docs/ui-for-agents/mcp-server) that lets AI assistants like Cursor, Claude Code, and VS Code Copilot access blakeUI documentation and component information directly.
...
<div className="flex items-center gap-3 mb-4">
  <a
    href="https://link.blakeui.com/mcp-cursor-install"
...
3. **Update imports:**
   ...
   import {Card, CloseButton} from "@blakeui/react";
   ```

## Links

- [GitHub PR #5747](https://github.com/blakeui/blakeui/pull/5747)
