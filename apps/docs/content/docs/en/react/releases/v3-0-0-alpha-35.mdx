...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @blakeui/styles@alpha @blakeui/react@alpha
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @blakeui/styles@alpha @blakeui/react@alpha
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @blakeui/styles@alpha @blakeui/react@alpha
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @blakeui/styles@alpha @blakeui/react@alpha
    ```
  </Tab>
</Tabs>
...
**After:**
```tsx
import { Switch, SwitchGroup } from "@blakeui/react"
...
**Migration Steps:**
1. Import `SwitchGroup` separately: `import { Switch, SwitchGroup } from "@blakeui/react"`
...
You have two options for using blakeUI compound components:
...
**Tabs Example:**
```tsx
import { TabsRoot, TabListContainer, TabList, Tab, TabIndicator, TabPanel } from "@blakeui/react"
...
**Avatar Example:**
```tsx
import { Avatar, AvatarImage, AvatarFallback } from "@blakeui/react"
...
- For Switch migrations, verify that `SwitchGroup` is imported: `import { Switch, SwitchGroup } from "@blakeui/react"`
...
4. Report issues at: [GitHub Issues](https://github.com/blakeui/blakeui/issues)
