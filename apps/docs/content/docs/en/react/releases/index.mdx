...
Patch release: new `Text` compound component ported from blakeUI Pro, docs theme selector, `min()`-capped border-radius tokens across 45+ component CSS files, reworked Table focus rings, and fixes for Checkbox, Autocomplete, Tooltip, and form field padding.

<VideoPlayer
  src="https://cdn.blakeui.com/videos/heroui-oss-3.0.4-4k.mp4"
  muted
/>
...
<DocsImage
  src="https://cdn.blakeui.com/docs/versions/rc-1-light@2x.jpg"
  darkSrc="https://cdn.blakeui.com/docs/versions/rc-1-dark@2x.jpg"
  alt="blakeUI RC 1"
...
<DocsImage
  src="https://cdn.blakeui.com/docs/versions/beta-8-light@2x.jpg"
  darkSrc="https://cdn.blakeui.com/docs/versions/beta-8-dark@2x.jpg"
  alt="blakeUI Beta 8"
...
<DocsImage
  src="https://cdn.blakeui.com/docs/versions/beta-7-light@2x.jpg"
  darkSrc="https://cdn.blakeui.com/docs/versions/beta-7-dark@2x.jpg"
  alt="blakeUI Beta 7"
...
<DocsImage
  src="https://cdn.blakeui.com/docs/versions/beta-6-light@2x.jpg"
  darkSrc="https://cdn.blakeui.com/docs/versions/beta-6-dark@2x.jpg"
  alt="blakeUI Beta 6"
...
<DocsImage
  src="https://cdn.blakeui.com/docs/versions/beta-4-light@2x.jpg"
  darkSrc="https://cdn.blakeui.com/docs/versions/beta-4-dark@2x.jpg"
  alt="blakeUI Beta 4"
  href="/docs/react/releases/v3-0-0-beta-4"
/>

<Callout type="warning">
  **Critical Build Issue Fixed**: This version (beta.4) had a critical build issue that has been fixed in **beta.5**. Please upgrade to `@blakeui/styles@3.0.0-beta.5` and `@blakeui/react@3.0.0-beta.5` to ensure proper TypeScript declaration generation and export resolution.
</Callout>
...
<DocsImage
  src="https://cdn.blakeui.com/docs/versions/beta-3-light@2x.jpg"
  darkSrc="https://cdn.blakeui.com/docs/versions/beta-3-dark@2x.jpg"
  alt="blakeUI Beta 3"
...
<DocsImage
  src="https://cdn.blakeui.com/docs/versions/beta-2-light@2x.jpg"
  darkSrc="https://cdn.blakeui.com/docs/versions/beta-2-dark@2x.jpg"
  alt="blakeUI Beta 2"
...
- 🎨 **Showcases page** - Gallery of sites built with blakeUI
...
blakeUI is now stable. Future releases follow a regular cycle:
...
Found an issue or want to contribute? Check out our [GitHub repository](https://github.com/blakeui/blakeui).
