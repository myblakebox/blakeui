...
blakeUI is now licensed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0), replacing the previous MIT license. Apache 2.0 provides the same permissive freedoms while adding an explicit patent grant for additional legal protection. No action is required from existing users.

## Bug Fixes

- **Tabs**: scope secondary-variant styles so nested tab groups no longer inherit the parent variant ([#6384](https://github.com/blakeui/blakeui/pull/6384))
...
- [GitHub PR #6441](https://github.com/blakeui/blakeui/pull/6441)
