...
This release introduces a comprehensive redesign of blakeUI, merging v2's beauty and animations with v3's simplicity. All components redesigned, 8 new components, and improved design system with better color tokens, shadows, and architecture.
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @blakeui/styles@beta @blakeui/react@beta
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @blakeui/styles@beta @blakeui/react@beta
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @blakeui/styles@beta @blakeui/react@beta
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @blakeui/styles@beta @blakeui/react@beta
    ```
  </Tab>
</Tabs>
...
We've spent weeks crafting a new design system that merges the soul of blakeUI v2 with the simplicity of v3. Every component has been redesigned with attention to detail, smooth animations, and improved developer experience. The new design system is available in our [Figma Kit V3](https://www.figma.com/community/file/1546526812159103429/blakeui-figma-kit-v3).

<VideoPlayer
  src="https://cdn.blakeui.com/docs/videos/v3-beta-1.mp4"
  poster="https://cdn.blakeui.com/docs/videos/v3-beta-1-poster.png"
  height={430}
  muted
/>
...
blakeUI now supports flexible component syntax. Use compound patterns with or without `.Root`, or named exports - all three patterns work identically.
...
// 3. Named exports
import { AvatarRoot, AvatarImage, AvatarFallback } from "@blakeui/react"
...
```tsx
import { Avatar, AvatarFallback } from "@blakeui/react"
...
/* BlakeUI automatically calculates these using color-mix */
...
blakeUI now automatically calculates shade levels and soft color variants using CSS `color-mix`. You only need to declare the base colors, and blakeUI handles the rest.
...
/* BlakeUI automatically calculates these */
...
/* BlakeUI automatically calculates these at 15% opacity */
...
blakeUI Pro is being reshaped from the ground up on top of the new design system. The new Pro version will feature:
- New components built on top of blakeUI
...
The reception on the native side has been phenomenal. Thank you for supporting us as we build blakeUI! Your feedback helps us improve every day.

See what the community is saying: [blakeUI Native Reception](https://x.com/blake_ui/status/1985721976220966926)

## Links

- [Component Documentation](/docs/react/components)
- [Design System - Figma Kit V3](https://www.figma.com/community/file/1546526812159103429/blakeui-figma-kit-v3)
- [blakeUI Native](https://link.blakeui.com/native)
- [GitHub Repository](https://github.com/blakeui/blakeui)
- [GitHub PR #5872](https://github.com/blakeui/blakeui/pull/5872)
