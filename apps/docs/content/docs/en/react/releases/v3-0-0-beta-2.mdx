...
```tsx
// Before
import type { SelectContentProps } from "@blakeui/react"

// After
import type { SelectPopoverProps } from "@blakeui/react"
```
...
```tsx
// Before
import { SelectContent } from "@blakeui/react"

// After
import { SelectPopover } from "@blakeui/react"
```
...
- [GitHub PR #5885](https://github.com/blakeui/blakeui/pull/5885)
