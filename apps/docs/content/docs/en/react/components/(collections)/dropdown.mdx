...
<Callout title="Completeness: behavior-required" type="warn">
  ...
  server with `get_component_behavior("Dropdown")` and build the behaviour yourself.
</Callout>

## Import

```tsx
import { Dropdown } from '@blakeui/react';
```
...
```tsx
import { Dropdown, Button, Label, Description, Header, Kbd, Separator } from '@blakeui/react';
...
```tsx
import { Dropdown, Button } from '@blakeui/react';
...
The Dropdown component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/dropdown.css)):
...
#### Menu Classes
- `.menu` - Base menu container ([menu.css](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/menu.css))
  - `[data-slot="separator"]` - Separator elements within the menu

#### MenuItem Classes
- `.menu-item` - Base menu item container ([menu-item.css](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/menu-item.css))
...
#### MenuSection Classes
- `.menu-section` - Base menu section container ([menu-section.css](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/menu-section.css))
...
```tsx
import { Dropdown, Button, Label } from '@blakeui/react';
...
```tsx
import { Dropdown, Button, Label, Header, Separator } from '@blakeui/react';
