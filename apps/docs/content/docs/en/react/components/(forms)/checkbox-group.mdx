...
```tsx
import { CheckboxGroup, Checkbox, Label, Description } from '@blakeui/react';
```
...
The CheckboxGroup component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/checkbox-group.css)):
