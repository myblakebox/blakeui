...
```tsx
import { DisclosureGroup } from '@blakeui/react';
```
...
```tsx
import {DisclosureGroup, Disclosure} from '@blakeui/react';
...
The DisclosureGroup component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/disclosure-group.css)):
