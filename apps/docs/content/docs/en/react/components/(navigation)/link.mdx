...
The Link component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/link.css)):
...
Since blakeUI uses [BEM](https://getbem.com/) classes, you can apply Link styles directly to any link element:
