...
```tsx
import { Disclosure } from '@blakeui/react';
```
...
The Disclosure component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/disclosure.css)):
