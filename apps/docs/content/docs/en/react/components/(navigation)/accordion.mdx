...
<Callout title="Completeness: behavior-required" type="warn">
  ...
  server with `get_component_behavior("Accordion")` and build the behaviour yourself.
</Callout>
...
const items = [
  ...
  },
  {
    ...
    iconUrl:
      "https://cdn.blakeui.com/docs/3dicons/mint-collective-small.png",
...
The Accordion component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/accordion.css)):
