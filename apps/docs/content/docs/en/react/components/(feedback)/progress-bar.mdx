...
```tsx
import { ProgressBar, Label } from '@blakeui/react';
```
...
The ProgressBar component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/progress-bar.css)):
