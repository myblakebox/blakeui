...
```tsx
import { Meter, Label } from '@blakeui/react';
```
...
The Meter component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/meter.css)):
