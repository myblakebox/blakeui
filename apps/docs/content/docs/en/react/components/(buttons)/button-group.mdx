...
```tsx
import { ButtonGroup, Button } from '@blakeui/react';
```
...
The ButtonGroup component uses these CSS classes ([View source styles](https://github.com/myblakebox/BlakeUI/blob/main/packages/styles/components/button-group.css)):
