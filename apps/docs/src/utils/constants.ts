...
export const REPO_NAME = "myblakebox/BlakeUI";

export const REPO_NAME_NATIVE = "myblakebox/BlakeUI";
...
export const STORYBOOK_URL = __DEV__ ? "http://localhost:6006" : "https://storybook.blakeui.com";

export const CDN_URL = "https://cdn.blakeui.com";
