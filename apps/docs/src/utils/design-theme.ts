...
export const DESIGN_THEME_STORAGE_KEY = "blakeui-docs-design-theme";
export const DESIGN_THEME_CHANGE_EVENT = "blakeui-docs-design-theme-change";
export const VIBRANT_STORAGE_KEY = "blakeui-docs-vibrant-palette";
