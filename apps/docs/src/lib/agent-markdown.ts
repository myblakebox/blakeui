...
blakeUI is the modern UI library for web and mobile, built to help teams move fast, stay consistent, and deliver delightful user experiences.
...
- [blakeUI React MCP server](${baseUrl}/docs/react/getting-started/mcp-server)
- [blakeUI Native MCP server](${baseUrl}/docs/native/getting-started/mcp-server)
- [blakeUI React Agent Skills](${baseUrl}/docs/react/getting-started/agent-skills)
- [blakeUI Native Agent Skills](${baseUrl}/docs/native/getting-started/agent-skills)
`;
}
