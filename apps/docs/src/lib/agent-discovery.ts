...
export const REACT_MCP_API_URL = "https://mcp-api.blakeui.com";
export const NATIVE_MCP_API_URL = "https://native-mcp-api.blakeui.com";

export const AGENT_SKILL_DESCRIPTIONS: Record<string, string> = {
  "blakeui-native":
    "Build React Native applications with blakeUI Native components, theme variables, and documentation lookup.",
  "blakeui-react":
    "Build React applications with blakeUI components, theming, styling, and documentation lookup.",
};
