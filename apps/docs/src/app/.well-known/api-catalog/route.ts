        ...
        linkset: [
          {
            ...
            "service-desc": [
              {
                href: absoluteUrl(origin, "/.well-known/openapi/blakeui-agent-api.json"),
          ...
          },
          {
            ...
            "service-desc": [
              {
                href: absoluteUrl(origin, "/.well-known/openapi/blakeui-react-mcp-api.json"),
                type: "application/vnd.oai.openapi+json",
              },
            ],
            "service-doc": [
          ...
          },
          {
            ...
            "service-desc": [
              {
                href: absoluteUrl(origin, "/.well-known/openapi/blakeui-native-mcp-api.json"),
                type: "application/vnd.oai.openapi+json",
              },
            ],
            "service-doc": [
