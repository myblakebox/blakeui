...
export const metadata: Metadata = {
  ...
  title: ["Privacy Policy", NATIVE_APP.NAME, "blakeUI"].join(" | "),
};
    ...
    <div className="prose mx-auto max-w-3xl px-4 py-24">
      ...
      <p>
        {[
          "The ",
          NATIVE_APP.NAME,
          " app (the “App”) is an interactive showcase that lets developers and designers preview, explore, and interact with the components, blocks, and patterns shipped by the blakeUI Native UI library. It is designed as a reference and evaluation tool to help teams adopt blakeUI Native in their own React Native applications.",
        ].join("")}
      </p>
      ...
      <p>
        {[
          ...
          NATIVE_APP.NAME,
          " app does not require an account, does not track user behaviour, and does not send usage statistics, crash reports, or analytics data to blakeUI or any third party.",
        ].join("")}
      </p>
      ...
      <p>
        {[
          "The ",
          NATIVE_APP.NAME,
          " app handles Universal Links and custom-scheme deep links that point at component previews on the blakeUI documentation site. When the App opens a deep link, the destination URL is resolved entirely on-device by the App’s native intent handler — the link target is never transmitted to a blakeUI-operated server or any third-party tracking service.",
        ].join("")}
      </p>
