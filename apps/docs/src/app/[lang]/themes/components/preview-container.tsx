...
export function PreviewContainer() {
  ...
  const sendMessageToIframe = useCallback(() => {
    ...
    iframe.contentWindow.postMessage({theme: resolvedTheme ?? "dark", type: "blakeui-theme"}, "*");
    iframe.contentWindow.postMessage({type: "blakeui-accent", vars: themeVars}, "*");
  ...
  useEffect(() => {
    function handleMessage(event: MessageEvent) {
      if (event.data?.type === "blakeui-ready") {
        sendMessageToIframe();
      }
    }
