...
// Featurebase changelog integration is DISABLED.
// The original implementation is kept commented out below for easy re-enabling.
export function POST() {
  return NextResponse.json({success: true});
}

/* Original Featurebase implementation (disabled):
