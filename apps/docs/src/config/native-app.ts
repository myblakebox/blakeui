/**
 * Centralised configuration for the blakeUI Native mobile app surfaces in the
 * docs site. Used by:
...
export const NATIVE_APP = {
  /**
   * App Store listing for the blakeUI Native iOS app. Always defined because
  ...
  /**
   * Human-readable product name used in copy ("Open in blakeUI Native",
   * "Download blakeUI Native on the App Store", etc.). Kept here so it tracks
   ...
   *    redirects the link into the installed blakeUI Native app.
