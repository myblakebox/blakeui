  ...
  return (
    <Accordion allowsMultipleExpanded className="w-full max-w-md">
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            Learn the basics of blakeUI and how to integrate it into your React project. This
      ...
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            Understand the fundamental concepts behind blakeUI, including the compound component
      ...
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            ...
            maintainable applications with blakeUI components.
          </Accordion.Body>
        </Accordion.Panel>
      </Accordion.Item>
    </Accordion>
