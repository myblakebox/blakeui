...
import {Button, Disclosure, DisclosureGroup, Separator} from "@blakeui/react";
    ...
    <div className="w-full max-w-md">
      <div className="flex flex-col gap-4 bg-transparent p-4">
        <DisclosureGroup expandedKeys={expandedKeys} onExpandedChange={setExpandedKeys}>
          <Disclosure aria-label="Preview blakeUI Native" id="preview">
            <Disclosure.Heading>
              <Button
                slot="trigger"
            ...
            <Disclosure.Content>
              <Disclosure.Body className="mx-2 flex flex-col items-center gap-2 p-4 text-center">
                <p className="text-sm text-muted">
                  Scan this QR code with your camera app to preview the blakeUI native components.
                </p>
                <img
                  alt="Expo Go QR Code"
                  className="aspect-square w-full max-w-54 object-cover"
                  src="https://cdn.blakeui.com/images/qr-code-native.png"
                />
          ...
          <Disclosure id="download">
            <Disclosure.Heading aria-label="Download blakeUI Native">
              <Button
                slot="trigger"
            ...
            <Disclosure.Content>
              <Disclosure.Body className="mx-2 flex flex-col items-center gap-2 p-4 text-center">
                <p className="text-sm text-muted">
                  Download the blakeUI native app to explore our mobile components directly on your
                  device.
                </p>
                <img
