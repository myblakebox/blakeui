...
export function Variants() {
  ...
  const variants = [
    ...
    {
      content: [
        "https://cdn.blakeui.com/avatars/users/3.jpg",
        "https://cdn.blakeui.com/avatars/users/4.jpg",
        "https://cdn.blakeui.com/avatars/users/5.jpg",
        "https://cdn.blakeui.com/avatars/users/8.jpg",
        "https://cdn.blakeui.com/avatars/users/16.jpg",
      ],
      label: "img",
      type: "img",
    },
