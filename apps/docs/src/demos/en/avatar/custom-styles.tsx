  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <Avatar className="size-16">
        <Avatar.Image alt="Extra Large" src="https://cdn.blakeui.com/avatars/blue.jpg" />
        <Avatar.Fallback>XL</Avatar.Fallback>
      </Avatar>

      {/* Square avatar */}
      <Avatar className="rounded-lg">
        <Avatar.Image alt="Square Avatar" src="https://cdn.blakeui.com/avatars/purple.jpg" />
      ...
      <Avatar className="bg-gradient-to-tr from-pink-500 to-yellow-500 p-0.5">
        <div className="size-full rounded-full bg-background p-0.5">
          <Avatar.Image
            ...
            src="https://cdn.blakeui.com/avatars/red.jpg"
          />
      ...
      <div className="relative">
        <Avatar>
          <Avatar.Image alt="Online User" src="https://cdn.blakeui.com/avatars/orange.jpg" />
