...
import {Avatar, Description, EmptyState, Label, Tag, TagGroup, useListData} from "@blakeui/react";
...
export function TagGroupWithListData() {
  ...
  const list = useListData<User>({
    ...
    initialItems: [
      {
        avatar: "https://cdn.blakeui.com/avatars/blue.jpg",
        fallback: "F",
        id: "fred",
        name: "Fred",
      },
      {
        avatar: "https://cdn.blakeui.com/avatars/green.jpg",
        fallback: "M",
        id: "michael",
        name: "Michael",
      },
      {
        avatar: "https://cdn.blakeui.com/avatars/purple.jpg",
        fallback: "J",
        id: "jane",
        name: "Jane",
      },
      {
        avatar: "https://cdn.blakeui.com/avatars/red.jpg",
        fallback: "A",
        id: "alice",
        name: "Alice",
      },
      {
        avatar: "https://cdn.blakeui.com/avatars/orange.jpg",
        fallback: "B",
        id: "bob",
        name: "Bob",
      },
      {
        avatar: "https://cdn.blakeui.com/avatars/black.jpg",
        fallback: "C",
        id: "charlie",
        name: "Charlie",
      },
